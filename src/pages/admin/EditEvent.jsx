...
function EditEvent() {
    ...
    if (state) {
      ...
      const FetchEvent = async () => {
        try {
          ...
          setEventsPreview(`${storage}/${data.foto_event}`);
          setSpeakerPreview(`${storage}/${data.foto_pembicara}`);
          ...
          setPopupMessage("Terjadi kesalahan saat memuat data event. Silakan coba lagi.");
  ...
  const handlePreview = async () => {
    ...
    try {
      ...
      if (event_img && typeof event_img !== 'string') {
        formData.append("event_img", event_img);
      }
      if (speaker_img && typeof speaker_img !== 'string') {
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex justify-end space-x-4 pt-8 border-t border-gray-200">
                      <button
                        type="button"
                        className={buttonSecondaryClasses}
                        onClick={step === 1 ? () => navigate("/my-events") : handleBack}
                      >
