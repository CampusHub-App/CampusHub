...
const PopUpGagal = ({ isVisible, onClose, message, user }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative booking w-[397px] h-[437px] px-6 py-6 mx-8 bg-white shadow-lg rounded-2xl flex flex-col justify-center gap-4 transition-all ${isExiting
      ...
      >
        <div className="unique-code-output flex justify-center items-center">
          <div
            className={`relative w-32 h-32 flex items-center justify-center rounded-full border-4 transition-all duration-500 ${isEntering
          ...
          >
            <svg
              ...
              className={`w-16 h-16 transform transition-all duration-500 ${isEntering
